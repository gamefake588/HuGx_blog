    ...
    switch (true) {
        ...
        default:
            ...
            query(select, (err, list) => {
                    ...
                    query(select_user, (err, user_data) => {
                        // 合并数据
                        list.map(item => {
